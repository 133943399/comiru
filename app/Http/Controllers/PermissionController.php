        ...
        if ($type == 1) {
            if ($user->pid == 0) {
                ...
                $menu['data'] = [["id" => 1, "pid" => 0, "title" => "学校管理员", "icon" => "", "path" => "", "component" => "", "target" => "_self", "children" => [
                    ...
                    ["id" => 4, "pid" => 1, "title" => "学校列表", "icon" => "", "path" => "/system/school", "component" => "/system/school", "target" => "_self"],
                    ["id" => 5, "pid" => 1, "title" => "聊天室", "icon" => "", "path" => "/system/chat", "component" => "/system/chat", "target" => "_self"],
                    ["id" => 5, "pid" => 1, "title" => "通知", "icon" => "", "path" => "/system/notice", "component" => "/system/notice", "target" => "_self"],
                ]]];
            } else {
                //普通教师
                $menu['data'] = [["id" => 1, "pid" => 0, "title" => "普通老师", "icon" => "", "path" => "", "component" => "", "target" => "_self", "children" => [
                    ["id" => 2, "pid" => 1, "title" => "查看学生", "icon" => "", "path" => "/system/student", "component" => "/user/students", "target" => "_self"],
            ...
            //student
            $menu['data'] = [
                ["id" => 1, "pid" => 0, "title" => "学生", "icon" => "el-icon-setting", "path" => "", "component" => "", "target" => "_self", "children" => [
                    ["id" => 2, "pid" => 1, "title" => "查看老师", "icon" => "", "path" => "/system/teacher", "component" => "/system/teacher", "target" => "_self"],
                    ["id" => 3, "pid" => 1, "title" => "聊天室", "icon" => "", "path" => "/system/chat", "component" => "/system/chat", "target" => "_self"],
                    ["id" => 5, "pid" => 1, "title" => "通知", "icon" => "", "path" => "/system/notice", "component" => "/system/notice", "target" => "_self"],
                ],
                ],
            ];
